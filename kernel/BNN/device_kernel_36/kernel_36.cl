...
__kernel void test(__global int32_t* restrict input_image) {
          ...
          if (2 <= yy_reuse) {
            ...
            for (int32_t ff = 0; ff < 16; ++ff) {
              if (2 <= xx_reuse) {
                ...
                int32_t conv0_temp;
                conv0_temp = sum;
                // printf("[%d %d %d] ", ff, yy_reuse-2, xx_reuse-2);
      ...
      for (int32_t c1 = 0; c1 < 16; ++c1) {
        for (int32_t h1 = 0; h1 < 32; ++h1) {
          for (int32_t w1 = 0; w1 < 32; ++w1) {
            ...
            layer1_0_conv1_temp1 = read_channel_intel(layer1_0_conv1_pipe_6);
      ...
      for (int32_t cc75 = 0; cc75 < 64; ++cc75) {
        for (int32_t ww73 = 0; ww73 < 8; ++ww73) {
          for (int32_t hh75 = 0; hh75 < 8; ++hh75) {
            ...
            layer3_2_rprelu2_temp = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_2_residual2_temp1) + ((int33_t)w_layer3_2_rprelu2_3[cc75])))) ? 
              (((int64_t)(((int33_t)layer3_2_residual2_temp1) + ((int33_t)w_layer3_2_rprelu2_3[cc75])))) 
              : ((int64_t)(((int64_t)w_layer3_2_rprelu2_5[cc75]) * ((int64_t)(((int33_t)layer3_2_residual2_temp1) + ((int33_t)w_layer3_2_rprelu2_3[cc75]))))))) + ((int64_t)w_layer3_2_rprelu2_4[cc75])));
...
__kernel void get_output(__global int32_t* restrict fc) {
    int32_t w_fc_168[10];
