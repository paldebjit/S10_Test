...
__kernel void test(__global int32_t* restrict input_image, __global int32_t* restrict fc) {
            ...
            for (int32_t rc = 0; rc < 3; ++rc) {
              for (int32_t ry = 0; ry < 3; ++ry) {
                for (int32_t rx = 0; rx < 3; ++rx) {
                  sum = ((int32_t)(((int64_t)(((int64_t)conv1_pad[((((xx + rx) + ((yy + ry) * 34)) + (rc * 1156)) + (nn * 3468))]) * ((int64_t)56))) + ((int64_t)sum)));
                }
              }
            }
      ...
      for (int32_t args0 = 0; args0 < 16; ++args0) {
        for (int32_t args1 = 0; args1 < 32; ++args1) {
          ...
          for (int32_t args2 = 0; args2 < 32; ++args2) {
            bn1[(((args2 + (args1 * 32)) + (args0 * 1024)) + (x * 16384))] = ((int32_t)(((int64_t)(((int64_t)conv1[(((args2 + (args1 * 32)) + (args0 * 1024)) + (x * 16384))]) * ((int64_t)128))) + ((int64_t)128)));
          }
        }
      }
    }
      ...
      for (int32_t cc = 0; cc < 16; ++cc) {
        for (int32_t ww = 0; ww < 32; ++ww) {
          ...
          for (int32_t hh = 0; hh < 32; ++hh) {
            layer1_0_rsign1[(((hh + (ww * 32)) + (cc * 1024)) + (nn1 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)bn1[(((hh + (ww * 32)) + (cc * 1024)) + (nn1 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args01 = 0; args01 < 16; ++args01) {
        for (int32_t args11 = 0; args11 < 32; ++args11) {
          ...
          for (int32_t args21 = 0; args21 < 32; ++args21) {
            layer1_0_bn1[(((args21 + (args11 * 32)) + (args01 * 1024)) + (x1 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_0_conv1[(((args21 + (args11 * 32)) + (args01 * 1024)) + (x1 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc2 = 0; cc2 < 16; ++cc2) {
        for (int32_t ww2 = 0; ww2 < 32; ++ww2) {
          ...
          for (int32_t hh2 = 0; hh2 < 32; ++hh2) {
            layer1_0_rprelu1[(((hh2 + (ww2 * 32)) + (cc2 * 1024)) + (nn4 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_0_residual1[(((hh2 + (ww2 * 32)) + (cc2 * 1024)) + (nn4 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_0_residual1[(((hh2 + (ww2 * 32)) + (cc2 * 1024)) + (nn4 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_0_residual1[(((hh2 + (ww2 * 32)) + (cc2 * 1024)) + (nn4 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc3 = 0; cc3 < 16; ++cc3) {
        for (int32_t ww3 = 0; ww3 < 32; ++ww3) {
          ...
          for (int32_t hh3 = 0; hh3 < 32; ++hh3) {
            layer1_0_rsign2[(((hh3 + (ww3 * 32)) + (cc3 * 1024)) + (nn5 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_0_rprelu1[(((hh3 + (ww3 * 32)) + (cc3 * 1024)) + (nn5 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args02 = 0; args02 < 16; ++args02) {
        for (int32_t args12 = 0; args12 < 32; ++args12) {
          ...
          for (int32_t args22 = 0; args22 < 32; ++args22) {
            layer1_0_bn2[(((args22 + (args12 * 32)) + (args02 * 1024)) + (x2 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_0_conv2[(((args22 + (args12 * 32)) + (args02 * 1024)) + (x2 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc5 = 0; cc5 < 16; ++cc5) {
        for (int32_t ww5 = 0; ww5 < 32; ++ww5) {
          ...
          for (int32_t hh5 = 0; hh5 < 32; ++hh5) {
            layer1_0_rprelu2[(((hh5 + (ww5 * 32)) + (cc5 * 1024)) + (nn8 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_0_residual2[(((hh5 + (ww5 * 32)) + (cc5 * 1024)) + (nn8 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_0_residual2[(((hh5 + (ww5 * 32)) + (cc5 * 1024)) + (nn8 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_0_residual2[(((hh5 + (ww5 * 32)) + (cc5 * 1024)) + (nn8 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc6 = 0; cc6 < 16; ++cc6) {
        for (int32_t ww6 = 0; ww6 < 32; ++ww6) {
          ...
          for (int32_t hh6 = 0; hh6 < 32; ++hh6) {
            layer1_1_rsign1[(((hh6 + (ww6 * 32)) + (cc6 * 1024)) + (nn9 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_0_rprelu2[(((hh6 + (ww6 * 32)) + (cc6 * 1024)) + (nn9 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args03 = 0; args03 < 16; ++args03) {
        for (int32_t args13 = 0; args13 < 32; ++args13) {
          ...
          for (int32_t args23 = 0; args23 < 32; ++args23) {
            layer1_1_bn1[(((args23 + (args13 * 32)) + (args03 * 1024)) + (x3 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_1_conv1[(((args23 + (args13 * 32)) + (args03 * 1024)) + (x3 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc8 = 0; cc8 < 16; ++cc8) {
        for (int32_t ww8 = 0; ww8 < 32; ++ww8) {
          ...
          for (int32_t hh8 = 0; hh8 < 32; ++hh8) {
            layer1_1_rprelu1[(((hh8 + (ww8 * 32)) + (cc8 * 1024)) + (nn12 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_1_residual1[(((hh8 + (ww8 * 32)) + (cc8 * 1024)) + (nn12 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_1_residual1[(((hh8 + (ww8 * 32)) + (cc8 * 1024)) + (nn12 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_1_residual1[(((hh8 + (ww8 * 32)) + (cc8 * 1024)) + (nn12 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc9 = 0; cc9 < 16; ++cc9) {
        for (int32_t ww9 = 0; ww9 < 32; ++ww9) {
          ...
          for (int32_t hh9 = 0; hh9 < 32; ++hh9) {
            layer1_1_rsign2[(((hh9 + (ww9 * 32)) + (cc9 * 1024)) + (nn13 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_1_rprelu1[(((hh9 + (ww9 * 32)) + (cc9 * 1024)) + (nn13 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args04 = 0; args04 < 16; ++args04) {
        for (int32_t args14 = 0; args14 < 32; ++args14) {
          ...
          for (int32_t args24 = 0; args24 < 32; ++args24) {
            layer1_1_bn2[(((args24 + (args14 * 32)) + (args04 * 1024)) + (x4 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_1_conv2[(((args24 + (args14 * 32)) + (args04 * 1024)) + (x4 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc11 = 0; cc11 < 16; ++cc11) {
        for (int32_t ww11 = 0; ww11 < 32; ++ww11) {
          ...
          for (int32_t hh11 = 0; hh11 < 32; ++hh11) {
            layer1_1_rprelu2[(((hh11 + (ww11 * 32)) + (cc11 * 1024)) + (nn16 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_1_residual2[(((hh11 + (ww11 * 32)) + (cc11 * 1024)) + (nn16 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_1_residual2[(((hh11 + (ww11 * 32)) + (cc11 * 1024)) + (nn16 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_1_residual2[(((hh11 + (ww11 * 32)) + (cc11 * 1024)) + (nn16 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc12 = 0; cc12 < 16; ++cc12) {
        for (int32_t ww12 = 0; ww12 < 32; ++ww12) {
          ...
          for (int32_t hh12 = 0; hh12 < 32; ++hh12) {
            layer1_2_rsign1[(((hh12 + (ww12 * 32)) + (cc12 * 1024)) + (nn17 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_1_rprelu2[(((hh12 + (ww12 * 32)) + (cc12 * 1024)) + (nn17 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args05 = 0; args05 < 16; ++args05) {
        for (int32_t args15 = 0; args15 < 32; ++args15) {
          ...
          for (int32_t args25 = 0; args25 < 32; ++args25) {
            layer1_2_bn1[(((args25 + (args15 * 32)) + (args05 * 1024)) + (x5 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_2_conv1[(((args25 + (args15 * 32)) + (args05 * 1024)) + (x5 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc14 = 0; cc14 < 16; ++cc14) {
        for (int32_t ww14 = 0; ww14 < 32; ++ww14) {
          ...
          for (int32_t hh14 = 0; hh14 < 32; ++hh14) {
            layer1_2_rprelu1[(((hh14 + (ww14 * 32)) + (cc14 * 1024)) + (nn20 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_2_residual1[(((hh14 + (ww14 * 32)) + (cc14 * 1024)) + (nn20 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_2_residual1[(((hh14 + (ww14 * 32)) + (cc14 * 1024)) + (nn20 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_2_residual1[(((hh14 + (ww14 * 32)) + (cc14 * 1024)) + (nn20 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc15 = 0; cc15 < 16; ++cc15) {
        for (int32_t ww15 = 0; ww15 < 32; ++ww15) {
          ...
          for (int32_t hh15 = 0; hh15 < 32; ++hh15) {
            layer1_2_rsign2[(((hh15 + (ww15 * 32)) + (cc15 * 1024)) + (nn21 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_2_rprelu1[(((hh15 + (ww15 * 32)) + (cc15 * 1024)) + (nn21 * 16384))]) + ((int33_t)512)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args06 = 0; args06 < 16; ++args06) {
        for (int32_t args16 = 0; args16 < 32; ++args16) {
          ...
          for (int32_t args26 = 0; args26 < 32; ++args26) {
            layer1_2_bn2[(((args26 + (args16 * 32)) + (args06 * 1024)) + (x6 * 16384))] = ((int32_t)(((int41_t)(((int64_t)layer1_2_conv2[(((args26 + (args16 * 32)) + (args06 * 1024)) + (x6 * 16384))]) * ((int40_t)512))) + ((int41_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc17 = 0; cc17 < 16; ++cc17) {
        for (int32_t ww17 = 0; ww17 < 32; ++ww17) {
          ...
          for (int32_t hh17 = 0; hh17 < 32; ++hh17) {
            layer1_2_rprelu2[(((hh17 + (ww17 * 32)) + (cc17 * 1024)) + (nn24 * 16384))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_2_residual2[(((hh17 + (ww17 * 32)) + (cc17 * 1024)) + (nn24 * 16384))]) + ((int33_t)512)))) ? (((int64_t)(((int33_t)layer1_2_residual2[(((hh17 + (ww17 * 32)) + (cc17 * 1024)) + (nn24 * 16384))]) + ((int33_t)512)))) : ((int64_t)(((int64_t)512) * ((int64_t)(((int33_t)layer1_2_residual2[(((hh17 + (ww17 * 32)) + (cc17 * 1024)) + (nn24 * 16384))]) + ((int33_t)512))))))) + ((int64_t)512)));
          }
        }
      }
    }
      ...
      for (int32_t cc18 = 0; cc18 < 16; ++cc18) {
        for (int32_t ww18 = 0; ww18 < 32; ++ww18) {
          ...
          for (int32_t hh18 = 0; hh18 < 32; ++hh18) {
            layer2_0_rsign1[(((hh18 + (ww18 * 32)) + (cc18 * 1024)) + (nn25 * 16384))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer1_2_rprelu2[(((hh18 + (ww18 * 32)) + (cc18 * 1024)) + (nn25 * 16384))]) + ((int33_t)256)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args07 = 0; args07 < 32; ++args07) {
        for (int32_t args17 = 0; args17 < 16; ++args17) {
          ...
          for (int32_t args27 = 0; args27 < 16; ++args27) {
            layer2_0_bn1[(((args27 + (args17 * 16)) + (args07 * 256)) + (x7 * 8192))] = ((int32_t)(((int41_t)(((int64_t)layer2_0_conv1[(((args27 + (args17 * 16)) + (args07 * 256)) + (x7 * 8192))]) * ((int40_t)256))) + ((int41_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc22 = 0; cc22 < 32; ++cc22) {
        for (int32_t ww21 = 0; ww21 < 16; ++ww21) {
          ...
          for (int32_t hh22 = 0; hh22 < 16; ++hh22) {
            layer2_0_rprelu1[(((hh22 + (ww21 * 16)) + (cc22 * 256)) + (nn29 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_0_residual1[(((hh22 + (ww21 * 16)) + (cc22 * 256)) + (nn29 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_0_residual1[(((hh22 + (ww21 * 16)) + (cc22 * 256)) + (nn29 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_0_residual1[(((hh22 + (ww21 * 16)) + (cc22 * 256)) + (nn29 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t args08 = 0; args08 < 32; ++args08) {
        for (int32_t args18 = 0; args18 < 16; ++args18) {
          ...
          for (int32_t args28 = 0; args28 < 16; ++args28) {
            layer2_0_bn2[(((args28 + (args18 * 16)) + (args08 * 256)) + (x8 * 8192))] = ((int32_t)(((int41_t)(((int64_t)layer2_0_conv2[(((args28 + (args18 * 16)) + (args08 * 256)) + (x8 * 8192))]) * ((int40_t)256))) + ((int41_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc25 = 0; cc25 < 32; ++cc25) {
        for (int32_t ww24 = 0; ww24 < 16; ++ww24) {
          ...
          for (int32_t hh25 = 0; hh25 < 16; ++hh25) {
            layer2_0_rprelu2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t args09 = 0; args09 < 32; ++args09) {
        for (int32_t args19 = 0; args19 < 16; ++args19) {
          ...
          for (int32_t args29 = 0; args29 < 16; ++args29) {
            layer2_1_bn1[(((args29 + (args19 * 16)) + (args09 * 256)) + (x9 * 8192))] = ((int32_t)(((int41_t)(((int64_t)layer2_1_conv1[(((args29 + (args19 * 16)) + (args09 * 256)) + (x9 * 8192))]) * ((int40_t)256))) + ((int41_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc28 = 0; cc28 < 32; ++cc28) {
        for (int32_t ww27 = 0; ww27 < 16; ++ww27) {
          ...
          for (int32_t hh28 = 0; hh28 < 16; ++hh28) {
            layer2_1_rprelu1[(((hh28 + (ww27 * 16)) + (cc28 * 256)) + (nn37 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_1_residual1[(((hh28 + (ww27 * 16)) + (cc28 * 256)) + (nn37 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_1_residual1[(((hh28 + (ww27 * 16)) + (cc28 * 256)) + (nn37 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_1_residual1[(((hh28 + (ww27 * 16)) + (cc28 * 256)) + (nn37 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc29 = 0; cc29 < 32; ++cc29) {
        for (int32_t ww28 = 0; ww28 < 16; ++ww28) {
          ...
          for (int32_t hh29 = 0; hh29 < 16; ++hh29) {
            layer2_1_rsign2[(((hh29 + (ww28 * 16)) + (cc29 * 256)) + (nn38 * 8192))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_1_rprelu1[(((hh29 + (ww28 * 16)) + (cc29 * 256)) + (nn38 * 8192))]) + ((int33_t)256)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t cc31 = 0; cc31 < 32; ++cc31) {
        for (int32_t ww30 = 0; ww30 < 16; ++ww30) {
          ...
          for (int32_t hh31 = 0; hh31 < 16; ++hh31) {
            layer2_1_rprelu2[(((hh31 + (ww30 * 16)) + (cc31 * 256)) + (nn41 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_1_residual2[(((hh31 + (ww30 * 16)) + (cc31 * 256)) + (nn41 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_1_residual2[(((hh31 + (ww30 * 16)) + (cc31 * 256)) + (nn41 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_1_residual2[(((hh31 + (ww30 * 16)) + (cc31 * 256)) + (nn41 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc32 = 0; cc32 < 32; ++cc32) {
        for (int32_t ww31 = 0; ww31 < 16; ++ww31) {
          ...
          for (int32_t hh32 = 0; hh32 < 16; ++hh32) {
            layer2_2_rsign1[(((hh32 + (ww31 * 16)) + (cc32 * 256)) + (nn42 * 8192))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_1_rprelu2[(((hh32 + (ww31 * 16)) + (cc32 * 256)) + (nn42 * 8192))]) + ((int33_t)256)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args011 = 0; args011 < 32; ++args011) {
        for (int32_t args111 = 0; args111 < 16; ++args111) {
          ...
          for (int32_t args211 = 0; args211 < 16; ++args211) {
            layer2_2_bn1[(((args211 + (args111 * 16)) + (args011 * 256)) + (x11 * 8192))] = ((int32_t)(((int41_t)(((int64_t)layer2_2_conv1[(((args211 + (args111 * 16)) + (args011 * 256)) + (x11 * 8192))]) * ((int40_t)256))) + ((int41_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc34 = 0; cc34 < 32; ++cc34) {
        for (int32_t ww33 = 0; ww33 < 16; ++ww33) {
          ...
          for (int32_t hh34 = 0; hh34 < 16; ++hh34) {
            layer2_2_rprelu1[(((hh34 + (ww33 * 16)) + (cc34 * 256)) + (nn45 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_2_residual1[(((hh34 + (ww33 * 16)) + (cc34 * 256)) + (nn45 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_2_residual1[(((hh34 + (ww33 * 16)) + (cc34 * 256)) + (nn45 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_2_residual1[(((hh34 + (ww33 * 16)) + (cc34 * 256)) + (nn45 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc35 = 0; cc35 < 32; ++cc35) {
        for (int32_t ww34 = 0; ww34 < 16; ++ww34) {
          ...
          for (int32_t hh35 = 0; hh35 < 16; ++hh35) {
            layer2_2_rsign2[(((hh35 + (ww34 * 16)) + (cc35 * 256)) + (nn46 * 8192))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_2_rprelu1[(((hh35 + (ww34 * 16)) + (cc35 * 256)) + (nn46 * 8192))]) + ((int33_t)256)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args012 = 0; args012 < 32; ++args012) {
        for (int32_t args112 = 0; args112 < 16; ++args112) {
          ...
          for (int32_t args212 = 0; args212 < 16; ++args212) {
            layer2_2_bn2[(((args212 + (args112 * 16)) + (args012 * 256)) + (x12 * 8192))] = ((int32_t)(((int41_t)(((int64_t)layer2_2_conv2[(((args212 + (args112 * 16)) + (args012 * 256)) + (x12 * 8192))]) * ((int40_t)256))) + ((int41_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc37 = 0; cc37 < 32; ++cc37) {
        for (int32_t ww36 = 0; ww36 < 16; ++ww36) {
          ...
          for (int32_t hh37 = 0; hh37 < 16; ++hh37) {
            layer2_2_rprelu2[(((hh37 + (ww36 * 16)) + (cc37 * 256)) + (nn49 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_2_residual2[(((hh37 + (ww36 * 16)) + (cc37 * 256)) + (nn49 * 8192))]) + ((int33_t)256)))) ? (((int64_t)(((int33_t)layer2_2_residual2[(((hh37 + (ww36 * 16)) + (cc37 * 256)) + (nn49 * 8192))]) + ((int33_t)256)))) : ((int64_t)(((int64_t)256) * ((int64_t)(((int33_t)layer2_2_residual2[(((hh37 + (ww36 * 16)) + (cc37 * 256)) + (nn49 * 8192))]) + ((int33_t)256))))))) + ((int64_t)256)));
          }
        }
      }
    }
      ...
      for (int32_t cc38 = 0; cc38 < 32; ++cc38) {
        for (int32_t ww37 = 0; ww37 < 16; ++ww37) {
          ...
          for (int32_t hh38 = 0; hh38 < 16; ++hh38) {
            layer3_0_rsign1[(((hh38 + (ww37 * 16)) + (cc38 * 256)) + (nn50 * 8192))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_2_rprelu2[(((hh38 + (ww37 * 16)) + (cc38 * 256)) + (nn50 * 8192))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args013 = 0; args013 < 64; ++args013) {
        for (int32_t args113 = 0; args113 < 8; ++args113) {
          ...
          for (int32_t args213 = 0; args213 < 8; ++args213) {
            layer3_0_bn1[(((args213 + (args113 * 8)) + (args013 * 64)) + (x13 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_0_conv1[(((args213 + (args113 * 8)) + (args013 * 64)) + (x13 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc42 = 0; cc42 < 64; ++cc42) {
        for (int32_t ww40 = 0; ww40 < 8; ++ww40) {
          ...
          for (int32_t hh42 = 0; hh42 < 8; ++hh42) {
            layer3_0_rprelu1[(((hh42 + (ww40 * 8)) + (cc42 * 64)) + (nn54 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_0_residual1[(((hh42 + (ww40 * 8)) + (cc42 * 64)) + (nn54 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_0_residual1[(((hh42 + (ww40 * 8)) + (cc42 * 64)) + (nn54 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_0_residual1[(((hh42 + (ww40 * 8)) + (cc42 * 64)) + (nn54 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc43 = 0; cc43 < 64; ++cc43) {
        for (int32_t ww41 = 0; ww41 < 8; ++ww41) {
          ...
          for (int32_t hh43 = 0; hh43 < 8; ++hh43) {
            layer3_0_rsign2[(((hh43 + (ww41 * 8)) + (cc43 * 64)) + (nn55 * 4096))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_0_rprelu1[(((hh43 + (ww41 * 8)) + (cc43 * 64)) + (nn55 * 4096))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args014 = 0; args014 < 64; ++args014) {
        for (int32_t args114 = 0; args114 < 8; ++args114) {
          ...
          for (int32_t args214 = 0; args214 < 8; ++args214) {
            layer3_0_bn2[(((args214 + (args114 * 8)) + (args014 * 64)) + (x14 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_0_conv2[(((args214 + (args114 * 8)) + (args014 * 64)) + (x14 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc45 = 0; cc45 < 64; ++cc45) {
        for (int32_t ww43 = 0; ww43 < 8; ++ww43) {
          ...
          for (int32_t hh45 = 0; hh45 < 8; ++hh45) {
            layer3_0_rprelu2[(((hh45 + (ww43 * 8)) + (cc45 * 64)) + (nn58 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_0_residual2[(((hh45 + (ww43 * 8)) + (cc45 * 64)) + (nn58 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_0_residual2[(((hh45 + (ww43 * 8)) + (cc45 * 64)) + (nn58 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_0_residual2[(((hh45 + (ww43 * 8)) + (cc45 * 64)) + (nn58 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc46 = 0; cc46 < 64; ++cc46) {
        for (int32_t ww44 = 0; ww44 < 8; ++ww44) {
          ...
          for (int32_t hh46 = 0; hh46 < 8; ++hh46) {
            layer3_1_rsign1[(((hh46 + (ww44 * 8)) + (cc46 * 64)) + (nn59 * 4096))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_0_rprelu2[(((hh46 + (ww44 * 8)) + (cc46 * 64)) + (nn59 * 4096))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args015 = 0; args015 < 64; ++args015) {
        for (int32_t args115 = 0; args115 < 8; ++args115) {
          ...
          for (int32_t args215 = 0; args215 < 8; ++args215) {
            layer3_1_bn1[(((args215 + (args115 * 8)) + (args015 * 64)) + (x15 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_1_conv1[(((args215 + (args115 * 8)) + (args015 * 64)) + (x15 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc48 = 0; cc48 < 64; ++cc48) {
        for (int32_t ww46 = 0; ww46 < 8; ++ww46) {
          ...
          for (int32_t hh48 = 0; hh48 < 8; ++hh48) {
            layer3_1_rprelu1[(((hh48 + (ww46 * 8)) + (cc48 * 64)) + (nn62 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_1_residual1[(((hh48 + (ww46 * 8)) + (cc48 * 64)) + (nn62 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_1_residual1[(((hh48 + (ww46 * 8)) + (cc48 * 64)) + (nn62 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_1_residual1[(((hh48 + (ww46 * 8)) + (cc48 * 64)) + (nn62 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc49 = 0; cc49 < 64; ++cc49) {
        for (int32_t ww47 = 0; ww47 < 8; ++ww47) {
          ...
          for (int32_t hh49 = 0; hh49 < 8; ++hh49) {
            layer3_1_rsign2[(((hh49 + (ww47 * 8)) + (cc49 * 64)) + (nn63 * 4096))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_1_rprelu1[(((hh49 + (ww47 * 8)) + (cc49 * 64)) + (nn63 * 4096))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args016 = 0; args016 < 64; ++args016) {
        for (int32_t args116 = 0; args116 < 8; ++args116) {
          ...
          for (int32_t args216 = 0; args216 < 8; ++args216) {
            layer3_1_bn2[(((args216 + (args116 * 8)) + (args016 * 64)) + (x16 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_1_conv2[(((args216 + (args116 * 8)) + (args016 * 64)) + (x16 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc51 = 0; cc51 < 64; ++cc51) {
        for (int32_t ww49 = 0; ww49 < 8; ++ww49) {
          ...
          for (int32_t hh51 = 0; hh51 < 8; ++hh51) {
            layer3_1_rprelu2[(((hh51 + (ww49 * 8)) + (cc51 * 64)) + (nn66 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_1_residual2[(((hh51 + (ww49 * 8)) + (cc51 * 64)) + (nn66 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_1_residual2[(((hh51 + (ww49 * 8)) + (cc51 * 64)) + (nn66 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_1_residual2[(((hh51 + (ww49 * 8)) + (cc51 * 64)) + (nn66 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc52 = 0; cc52 < 64; ++cc52) {
        for (int32_t ww50 = 0; ww50 < 8; ++ww50) {
          ...
          for (int32_t hh52 = 0; hh52 < 8; ++hh52) {
            layer3_2_rsign1[(((hh52 + (ww50 * 8)) + (cc52 * 64)) + (nn67 * 4096))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_1_rprelu2[(((hh52 + (ww50 * 8)) + (cc52 * 64)) + (nn67 * 4096))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args017 = 0; args017 < 64; ++args017) {
        for (int32_t args117 = 0; args117 < 8; ++args117) {
          ...
          for (int32_t args217 = 0; args217 < 8; ++args217) {
            layer3_2_bn1[(((args217 + (args117 * 8)) + (args017 * 64)) + (x17 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_2_conv1[(((args217 + (args117 * 8)) + (args017 * 64)) + (x17 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc54 = 0; cc54 < 64; ++cc54) {
        for (int32_t ww52 = 0; ww52 < 8; ++ww52) {
          ...
          for (int32_t hh54 = 0; hh54 < 8; ++hh54) {
            layer3_2_rprelu1[(((hh54 + (ww52 * 8)) + (cc54 * 64)) + (nn70 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_2_residual1[(((hh54 + (ww52 * 8)) + (cc54 * 64)) + (nn70 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_2_residual1[(((hh54 + (ww52 * 8)) + (cc54 * 64)) + (nn70 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_2_residual1[(((hh54 + (ww52 * 8)) + (cc54 * 64)) + (nn70 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc55 = 0; cc55 < 64; ++cc55) {
        for (int32_t ww53 = 0; ww53 < 8; ++ww53) {
          ...
          for (int32_t hh55 = 0; hh55 < 8; ++hh55) {
            layer3_2_rsign2[(((hh55 + (ww53 * 8)) + (cc55 * 64)) + (nn71 * 4096))] = ((bool)(int32_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_2_rprelu1[(((hh55 + (ww53 * 8)) + (cc55 * 64)) + (nn71 * 4096))]) + ((int33_t)448)))) ? ((int32_t)1) : ((int32_t)0)));
          }
        }
      }
    }
      ...
      for (int32_t args018 = 0; args018 < 64; ++args018) {
        for (int32_t args118 = 0; args118 < 8; ++args118) {
          ...
          for (int32_t args218 = 0; args218 < 8; ++args218) {
            layer3_2_bn2[(((args218 + (args118 * 8)) + (args018 * 64)) + (x18 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_2_conv2[(((args218 + (args118 * 8)) + (args018 * 64)) + (x18 * 4096))]) * ((int40_t)448))) + ((int41_t)448)));
          }
        }
      }
    }
      ...
      for (int32_t cc57 = 0; cc57 < 64; ++cc57) {
        for (int32_t ww55 = 0; ww55 < 8; ++ww55) {
          ...
          for (int32_t hh57 = 0; hh57 < 8; ++hh57) {
            layer3_2_rprelu2[(((hh57 + (ww55 * 8)) + (cc57 * 64)) + (nn74 * 4096))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer3_2_residual2[(((hh57 + (ww55 * 8)) + (cc57 * 64)) + (nn74 * 4096))]) + ((int33_t)448)))) ? (((int64_t)(((int33_t)layer3_2_residual2[(((hh57 + (ww55 * 8)) + (cc57 * 64)) + (nn74 * 4096))]) + ((int33_t)448)))) : ((int64_t)(((int64_t)448) * ((int64_t)(((int33_t)layer3_2_residual2[(((hh57 + (ww55 * 8)) + (cc57 * 64)) + (nn74 * 4096))]) + ((int33_t)448))))))) + ((int64_t)448)));
          }
        }
      }
    }
    ...
    for (int32_t i20 = 0; i20 < 1; ++i20) {
      for (int32_t j1 = 0; j1 < 10; ++j1) {
        ...
        for (int32_t ra6 = 0; ra6 < 64; ++ra6) {
          reducer0 = (((float)(((int64_t)flatten[(ra6 + (i20 * 64))]) * ((int64_t)256))) + reducer0);
        }
    ...
    for (int32_t i21 = 0; i21 < 1; ++i21) {
      for (int32_t j2 = 0; j2 < 10; ++j2) {
        fc[(j2 + (i21 * 10))] = ((int32_t)(((int33_t)fc_matmul[(j2 + (i21 * 10))]) + ((int33_t)128)));
      }
    }
}
