      ...
      for (int32_t cc25 = 0; cc25 < 32; ++cc25) {
        for (int32_t ww24 = 0; ww24 < 16; ++ww24) {
          for (int32_t hh25 = 0; hh25 < 16; ++hh25) {
            layer2_0_rprelu2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))] = ((int32_t)(((int64_t)(int64_t)(((int44_t)0 < ((int44_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)ww24)))) ? (((int64_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)hh25)))) : ((int64_t)(((int64_t)hh25) * ((int64_t)(((int33_t)layer2_0_residual2[(((hh25 + (ww24 * 16)) + (cc25 * 256)) + (nn33 * 8192))]) + ((int33_t)ww24))))))) + ((int64_t)hh25)));
          }
        }
      }
    }
      ...
      for (int32_t args014 = 0; args014 < 64; ++args014) {
        for (int32_t args114 = 0; args114 < 8; ++args114) {
          for (int32_t args214 = 0; args214 < 8; ++args214) {
            layer3_0_bn2[(((args214 + (args114 * 8)) + (args014 * 64)) + (x14 * 4096))] = ((int32_t)(((int41_t)(((int64_t)layer3_0_conv2[(((args214 + (args114 * 8)) + (args014 * 64)) + (x14 * 4096))]) * ((int40_t)args214))) + ((int41_t)args214)));
          }
        }
      }
    }
