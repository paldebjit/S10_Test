// HASH:1230143103
#include "ihc_apint.h"
__kernel void test(__global int32_t* restrict input_image, __global int32_t* restrict conv1_weight, __global int32_t* restrict bn1_running_var, __global int32_t* restrict layer1_2_bn2_running_var, __global bool* restrict layer1_0_conv1_weight, __global bool* restrict layer1_0_conv2_weight, __global bool* restrict layer1_1_conv1_weight, __global bool* restrict layer1_1_conv2_weight, __global bool* restrict layer1_2_conv1_weight, __global bool* restrict layer1_2_conv2_weight, __global int32_t* restrict layer2_2_bn2_running_var, __global bool* restrict layer2_0_conv1_weight, __global bool* restrict layer2_0_conv2_weight, __global bool* restrict layer2_1_conv1_weight, __global bool* restrict layer2_1_conv2_weight, __global bool* restrict layer2_2_conv1_weight, __global bool* restrict layer2_2_conv2_weight, __global int32_t* restrict layer3_2_bn2_running_var, __global bool* restrict layer3_0_conv1_weight, __global bool* restrict layer3_0_conv2_weight, __global bool* restrict layer3_1_conv1_weight, __global bool* restrict layer3_1_conv2_weight, __global bool* restrict layer3_2_conv1_weight, __global bool* restrict layer3_2_conv2_weight, __global int32_t* restrict linear_weight, __global int32_t* restrict fc, __global int32_t* restrict linear_bias) {
    int32_t _top;
      ...
      for (int32_t ff = 0; ff < 16; ++ff) {
        for (int32_t yy_reuse = 0; yy_reuse < 34; ++yy_reuse) {
          ...
          for (int32_t xx_reuse = 0; xx_reuse < 34; ++xx_reuse) {
            for (int32_t conv1_pad_2 = 0; conv1_pad_2 < 3; ++conv1_pad_2) {
              for (int32_t conv1_pad_1 = 0; conv1_pad_1 < 2; ++conv1_pad_1) {
                conv1_LB[((xx_reuse + (conv1_pad_1 * 34)) + (conv1_pad_2 * 102))] = conv1_LB[(((xx_reuse + (conv1_pad_1 * 34)) + (conv1_pad_2 * 102)) + 34)];
              }
              conv1_LB[((xx_reuse + (conv1_pad_2 * 102)) + 68)] = conv1_pad[(((xx_reuse + (yy_reuse * 34)) + (conv1_pad_2 * 1156)) + (nn * 3468))];
            }
            if (2 <= yy_reuse) {
              for (int32_t conv1_LB_1 = 0; conv1_LB_1 < 3; ++conv1_LB_1) {
                for (int32_t conv1_LB_2 = 0; conv1_LB_2 < 3; ++conv1_LB_2) {
                  for (int32_t conv1_LB_0 = 0; conv1_LB_0 < 2; ++conv1_LB_0) {
                    conv1_WB[((conv1_LB_0 + (conv1_LB_1 * 3)) + (conv1_LB_2 * 9))] = conv1_WB[(((conv1_LB_0 + (conv1_LB_1 * 3)) + (conv1_LB_2 * 9)) + 1)];
                  }
                  conv1_WB[(((conv1_LB_1 + (conv1_LB_2 * 3)) * 3) + 2)] = conv1_LB[((xx_reuse + (conv1_LB_1 * 34)) + (conv1_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse) {
                int32_t sum;
                for (int32_t rc = 0; rc < 3; ++rc) {
                  for (int32_t ry = 0; ry < 3; ++ry) {
                    for (int32_t rx = 0; rx < 3; ++rx) {
                      sum = ((int32_t)(((int64_t)(((int64_t)conv1_WB[((rx + (ry * 3)) + (rc * 9))]) * ((int64_t)conv1_weight[(((rx + (ry * 3)) + (rc * 9)) + (ff * 27))]))) + ((int64_t)sum)));
                    }
                  }
                }
                conv1[((((xx_reuse + (yy_reuse * 32)) + (ff * 1024)) + (nn * 16384)) + -66)] = sum;
              }
            }
          }
        }
    ...
    bool layer1_0_conv1_LB[1632];
    bool layer1_0_conv1_WB[144];
      ...
      for (int32_t ff1 = 0; ff1 < 16; ++ff1) {
        for (int32_t yy_reuse1 = 0; yy_reuse1 < 34; ++yy_reuse1) {
          ...
          for (int32_t xx_reuse1 = 0; xx_reuse1 < 34; ++xx_reuse1) {
            for (int32_t layer1_0_conv1_pad_2 = 0; layer1_0_conv1_pad_2 < 16; ++layer1_0_conv1_pad_2) {
              for (int32_t layer1_0_conv1_pad_1 = 0; layer1_0_conv1_pad_1 < 2; ++layer1_0_conv1_pad_1) {
                layer1_0_conv1_LB[((xx_reuse1 + (layer1_0_conv1_pad_1 * 34)) + (layer1_0_conv1_pad_2 * 102))] = layer1_0_conv1_LB[(((xx_reuse1 + (layer1_0_conv1_pad_1 * 34)) + (layer1_0_conv1_pad_2 * 102)) + 34)];
              }
              layer1_0_conv1_LB[((xx_reuse1 + (layer1_0_conv1_pad_2 * 102)) + 68)] = layer1_0_conv1_pad[(((xx_reuse1 + (yy_reuse1 * 34)) + (layer1_0_conv1_pad_2 * 1156)) + (nn2 * 18496))];
            }
            if (2 <= yy_reuse1) {
              for (int32_t layer1_0_conv1_LB_1 = 0; layer1_0_conv1_LB_1 < 3; ++layer1_0_conv1_LB_1) {
                for (int32_t layer1_0_conv1_LB_2 = 0; layer1_0_conv1_LB_2 < 16; ++layer1_0_conv1_LB_2) {
                  for (int32_t layer1_0_conv1_LB_0 = 0; layer1_0_conv1_LB_0 < 2; ++layer1_0_conv1_LB_0) {
                    layer1_0_conv1_WB[((layer1_0_conv1_LB_0 + (layer1_0_conv1_LB_1 * 3)) + (layer1_0_conv1_LB_2 * 9))] = layer1_0_conv1_WB[(((layer1_0_conv1_LB_0 + (layer1_0_conv1_LB_1 * 3)) + (layer1_0_conv1_LB_2 * 9)) + 1)];
                  }
                  layer1_0_conv1_WB[(((layer1_0_conv1_LB_1 + (layer1_0_conv1_LB_2 * 3)) * 3) + 2)] = layer1_0_conv1_LB[((xx_reuse1 + (layer1_0_conv1_LB_1 * 34)) + (layer1_0_conv1_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse1) {
                ...
                for (int32_t rc1 = 0; rc1 < 16; ++rc1) {
                  for (int32_t ry1 = 0; ry1 < 3; ++ry1) {
                    for (int32_t rx1 = 0; rx1 < 3; ++rx1) {
                      layer1_0_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx1)) <= ((int64_t)(xx_reuse1 + -2))) && (((int64_t)(xx_reuse1 + -2)) < ((int64_t)33 - ((int64_t)rx1)))) && (((int64_t)1 - ((int64_t)ry1)) <= ((int64_t)(yy_reuse1 + -2)))) && (((int64_t)(yy_reuse1 + -2)) < ((int64_t)33 - ((int64_t)ry1)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_0_conv1_WB[((rx1 + (ry1 * 3)) + (rc1 * 9))])) ^ layer1_0_conv1_weight[(((rx1 + (ry1 * 3)) + (rc1 * 9)) + (ff1 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_0_conv1_sum)));
                    }
                  }
                }
                layer1_0_conv1[((((xx_reuse1 + (yy_reuse1 * 32)) + (ff1 * 1024)) + (nn2 * 16384)) + -66)] = layer1_0_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer1_0_conv2_LB[1632];
    bool layer1_0_conv2_WB[144];
      ...
      for (int32_t ff2 = 0; ff2 < 16; ++ff2) {
        for (int32_t yy_reuse2 = 0; yy_reuse2 < 34; ++yy_reuse2) {
          ...
          for (int32_t xx_reuse2 = 0; xx_reuse2 < 34; ++xx_reuse2) {
            for (int32_t layer1_0_conv2_pad_2 = 0; layer1_0_conv2_pad_2 < 16; ++layer1_0_conv2_pad_2) {
              for (int32_t layer1_0_conv2_pad_1 = 0; layer1_0_conv2_pad_1 < 2; ++layer1_0_conv2_pad_1) {
                layer1_0_conv2_LB[((xx_reuse2 + (layer1_0_conv2_pad_1 * 34)) + (layer1_0_conv2_pad_2 * 102))] = layer1_0_conv2_LB[(((xx_reuse2 + (layer1_0_conv2_pad_1 * 34)) + (layer1_0_conv2_pad_2 * 102)) + 34)];
              }
              layer1_0_conv2_LB[((xx_reuse2 + (layer1_0_conv2_pad_2 * 102)) + 68)] = layer1_0_conv2_pad[(((xx_reuse2 + (yy_reuse2 * 34)) + (layer1_0_conv2_pad_2 * 1156)) + (nn6 * 18496))];
            }
            if (2 <= yy_reuse2) {
              for (int32_t layer1_0_conv2_LB_1 = 0; layer1_0_conv2_LB_1 < 3; ++layer1_0_conv2_LB_1) {
                for (int32_t layer1_0_conv2_LB_2 = 0; layer1_0_conv2_LB_2 < 16; ++layer1_0_conv2_LB_2) {
                  for (int32_t layer1_0_conv2_LB_0 = 0; layer1_0_conv2_LB_0 < 2; ++layer1_0_conv2_LB_0) {
                    layer1_0_conv2_WB[((layer1_0_conv2_LB_0 + (layer1_0_conv2_LB_1 * 3)) + (layer1_0_conv2_LB_2 * 9))] = layer1_0_conv2_WB[(((layer1_0_conv2_LB_0 + (layer1_0_conv2_LB_1 * 3)) + (layer1_0_conv2_LB_2 * 9)) + 1)];
                  }
                  layer1_0_conv2_WB[(((layer1_0_conv2_LB_1 + (layer1_0_conv2_LB_2 * 3)) * 3) + 2)] = layer1_0_conv2_LB[((xx_reuse2 + (layer1_0_conv2_LB_1 * 34)) + (layer1_0_conv2_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse2) {
                ...
                for (int32_t rc2 = 0; rc2 < 16; ++rc2) {
                  for (int32_t ry2 = 0; ry2 < 3; ++ry2) {
                    for (int32_t rx2 = 0; rx2 < 3; ++rx2) {
                      layer1_0_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx2)) <= ((int64_t)(xx_reuse2 + -2))) && (((int64_t)(xx_reuse2 + -2)) < ((int64_t)33 - ((int64_t)rx2)))) && (((int64_t)1 - ((int64_t)ry2)) <= ((int64_t)(yy_reuse2 + -2)))) && (((int64_t)(yy_reuse2 + -2)) < ((int64_t)33 - ((int64_t)ry2)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_0_conv2_WB[((rx2 + (ry2 * 3)) + (rc2 * 9))])) ^ layer1_0_conv2_weight[(((rx2 + (ry2 * 3)) + (rc2 * 9)) + (ff2 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_0_conv2_sum)));
                    }
                  }
                }
                layer1_0_conv2[((((xx_reuse2 + (yy_reuse2 * 32)) + (ff2 * 1024)) + (nn6 * 16384)) + -66)] = layer1_0_conv2_sum;
              }
            }
          }
        }
    ...
    bool layer1_1_conv1_LB[1632];
    bool layer1_1_conv1_WB[144];
      ...
      for (int32_t ff3 = 0; ff3 < 16; ++ff3) {
        for (int32_t yy_reuse3 = 0; yy_reuse3 < 34; ++yy_reuse3) {
          ...
          for (int32_t xx_reuse3 = 0; xx_reuse3 < 34; ++xx_reuse3) {
            for (int32_t layer1_1_conv1_pad_2 = 0; layer1_1_conv1_pad_2 < 16; ++layer1_1_conv1_pad_2) {
              for (int32_t layer1_1_conv1_pad_1 = 0; layer1_1_conv1_pad_1 < 2; ++layer1_1_conv1_pad_1) {
                layer1_1_conv1_LB[((xx_reuse3 + (layer1_1_conv1_pad_1 * 34)) + (layer1_1_conv1_pad_2 * 102))] = layer1_1_conv1_LB[(((xx_reuse3 + (layer1_1_conv1_pad_1 * 34)) + (layer1_1_conv1_pad_2 * 102)) + 34)];
              }
              layer1_1_conv1_LB[((xx_reuse3 + (layer1_1_conv1_pad_2 * 102)) + 68)] = layer1_1_conv1_pad[(((xx_reuse3 + (yy_reuse3 * 34)) + (layer1_1_conv1_pad_2 * 1156)) + (nn10 * 18496))];
            }
            if (2 <= yy_reuse3) {
              for (int32_t layer1_1_conv1_LB_1 = 0; layer1_1_conv1_LB_1 < 3; ++layer1_1_conv1_LB_1) {
                for (int32_t layer1_1_conv1_LB_2 = 0; layer1_1_conv1_LB_2 < 16; ++layer1_1_conv1_LB_2) {
                  for (int32_t layer1_1_conv1_LB_0 = 0; layer1_1_conv1_LB_0 < 2; ++layer1_1_conv1_LB_0) {
                    layer1_1_conv1_WB[((layer1_1_conv1_LB_0 + (layer1_1_conv1_LB_1 * 3)) + (layer1_1_conv1_LB_2 * 9))] = layer1_1_conv1_WB[(((layer1_1_conv1_LB_0 + (layer1_1_conv1_LB_1 * 3)) + (layer1_1_conv1_LB_2 * 9)) + 1)];
                  }
                  layer1_1_conv1_WB[(((layer1_1_conv1_LB_1 + (layer1_1_conv1_LB_2 * 3)) * 3) + 2)] = layer1_1_conv1_LB[((xx_reuse3 + (layer1_1_conv1_LB_1 * 34)) + (layer1_1_conv1_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse3) {
                ...
                for (int32_t rc3 = 0; rc3 < 16; ++rc3) {
                  for (int32_t ry3 = 0; ry3 < 3; ++ry3) {
                    for (int32_t rx3 = 0; rx3 < 3; ++rx3) {
                      layer1_1_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx3)) <= ((int64_t)(xx_reuse3 + -2))) && (((int64_t)(xx_reuse3 + -2)) < ((int64_t)33 - ((int64_t)rx3)))) && (((int64_t)1 - ((int64_t)ry3)) <= ((int64_t)(yy_reuse3 + -2)))) && (((int64_t)(yy_reuse3 + -2)) < ((int64_t)33 - ((int64_t)ry3)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_1_conv1_WB[((rx3 + (ry3 * 3)) + (rc3 * 9))])) ^ layer1_1_conv1_weight[(((rx3 + (ry3 * 3)) + (rc3 * 9)) + (ff3 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_1_conv1_sum)));
                    }
                  }
                }
                layer1_1_conv1[((((xx_reuse3 + (yy_reuse3 * 32)) + (ff3 * 1024)) + (nn10 * 16384)) + -66)] = layer1_1_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer1_1_conv2_LB[1632];
    bool layer1_1_conv2_WB[144];
      ...
      for (int32_t ff4 = 0; ff4 < 16; ++ff4) {
        for (int32_t yy_reuse4 = 0; yy_reuse4 < 34; ++yy_reuse4) {
          ...
          for (int32_t xx_reuse4 = 0; xx_reuse4 < 34; ++xx_reuse4) {
            for (int32_t layer1_1_conv2_pad_2 = 0; layer1_1_conv2_pad_2 < 16; ++layer1_1_conv2_pad_2) {
              for (int32_t layer1_1_conv2_pad_1 = 0; layer1_1_conv2_pad_1 < 2; ++layer1_1_conv2_pad_1) {
                layer1_1_conv2_LB[((xx_reuse4 + (layer1_1_conv2_pad_1 * 34)) + (layer1_1_conv2_pad_2 * 102))] = layer1_1_conv2_LB[(((xx_reuse4 + (layer1_1_conv2_pad_1 * 34)) + (layer1_1_conv2_pad_2 * 102)) + 34)];
              }
              layer1_1_conv2_LB[((xx_reuse4 + (layer1_1_conv2_pad_2 * 102)) + 68)] = layer1_1_conv2_pad[(((xx_reuse4 + (yy_reuse4 * 34)) + (layer1_1_conv2_pad_2 * 1156)) + (nn14 * 18496))];
            }
            if (2 <= yy_reuse4) {
              for (int32_t layer1_1_conv2_LB_1 = 0; layer1_1_conv2_LB_1 < 3; ++layer1_1_conv2_LB_1) {
                for (int32_t layer1_1_conv2_LB_2 = 0; layer1_1_conv2_LB_2 < 16; ++layer1_1_conv2_LB_2) {
                  for (int32_t layer1_1_conv2_LB_0 = 0; layer1_1_conv2_LB_0 < 2; ++layer1_1_conv2_LB_0) {
                    layer1_1_conv2_WB[((layer1_1_conv2_LB_0 + (layer1_1_conv2_LB_1 * 3)) + (layer1_1_conv2_LB_2 * 9))] = layer1_1_conv2_WB[(((layer1_1_conv2_LB_0 + (layer1_1_conv2_LB_1 * 3)) + (layer1_1_conv2_LB_2 * 9)) + 1)];
                  }
                  layer1_1_conv2_WB[(((layer1_1_conv2_LB_1 + (layer1_1_conv2_LB_2 * 3)) * 3) + 2)] = layer1_1_conv2_LB[((xx_reuse4 + (layer1_1_conv2_LB_1 * 34)) + (layer1_1_conv2_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse4) {
                ...
                for (int32_t rc4 = 0; rc4 < 16; ++rc4) {
                  for (int32_t ry4 = 0; ry4 < 3; ++ry4) {
                    for (int32_t rx4 = 0; rx4 < 3; ++rx4) {
                      layer1_1_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx4)) <= ((int64_t)(xx_reuse4 + -2))) && (((int64_t)(xx_reuse4 + -2)) < ((int64_t)33 - ((int64_t)rx4)))) && (((int64_t)1 - ((int64_t)ry4)) <= ((int64_t)(yy_reuse4 + -2)))) && (((int64_t)(yy_reuse4 + -2)) < ((int64_t)33 - ((int64_t)ry4)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_1_conv2_WB[((rx4 + (ry4 * 3)) + (rc4 * 9))])) ^ layer1_1_conv2_weight[(((rx4 + (ry4 * 3)) + (rc4 * 9)) + (ff4 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_1_conv2_sum)));
                    }
                  }
                }
                layer1_1_conv2[((((xx_reuse4 + (yy_reuse4 * 32)) + (ff4 * 1024)) + (nn14 * 16384)) + -66)] = layer1_1_conv2_sum;
              }
            }
          }
        }
    ...
    bool layer1_2_conv1_LB[1632];
    bool layer1_2_conv1_WB[144];
      ...
      for (int32_t ff5 = 0; ff5 < 16; ++ff5) {
        for (int32_t yy_reuse5 = 0; yy_reuse5 < 34; ++yy_reuse5) {
          ...
          for (int32_t xx_reuse5 = 0; xx_reuse5 < 34; ++xx_reuse5) {
            for (int32_t layer1_2_conv1_pad_2 = 0; layer1_2_conv1_pad_2 < 16; ++layer1_2_conv1_pad_2) {
              for (int32_t layer1_2_conv1_pad_1 = 0; layer1_2_conv1_pad_1 < 2; ++layer1_2_conv1_pad_1) {
                layer1_2_conv1_LB[((xx_reuse5 + (layer1_2_conv1_pad_1 * 34)) + (layer1_2_conv1_pad_2 * 102))] = layer1_2_conv1_LB[(((xx_reuse5 + (layer1_2_conv1_pad_1 * 34)) + (layer1_2_conv1_pad_2 * 102)) + 34)];
              }
              layer1_2_conv1_LB[((xx_reuse5 + (layer1_2_conv1_pad_2 * 102)) + 68)] = layer1_2_conv1_pad[(((xx_reuse5 + (yy_reuse5 * 34)) + (layer1_2_conv1_pad_2 * 1156)) + (nn18 * 18496))];
            }
            if (2 <= yy_reuse5) {
              for (int32_t layer1_2_conv1_LB_1 = 0; layer1_2_conv1_LB_1 < 3; ++layer1_2_conv1_LB_1) {
                for (int32_t layer1_2_conv1_LB_2 = 0; layer1_2_conv1_LB_2 < 16; ++layer1_2_conv1_LB_2) {
                  for (int32_t layer1_2_conv1_LB_0 = 0; layer1_2_conv1_LB_0 < 2; ++layer1_2_conv1_LB_0) {
                    layer1_2_conv1_WB[((layer1_2_conv1_LB_0 + (layer1_2_conv1_LB_1 * 3)) + (layer1_2_conv1_LB_2 * 9))] = layer1_2_conv1_WB[(((layer1_2_conv1_LB_0 + (layer1_2_conv1_LB_1 * 3)) + (layer1_2_conv1_LB_2 * 9)) + 1)];
                  }
                  layer1_2_conv1_WB[(((layer1_2_conv1_LB_1 + (layer1_2_conv1_LB_2 * 3)) * 3) + 2)] = layer1_2_conv1_LB[((xx_reuse5 + (layer1_2_conv1_LB_1 * 34)) + (layer1_2_conv1_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse5) {
                ...
                for (int32_t rc5 = 0; rc5 < 16; ++rc5) {
                  for (int32_t ry5 = 0; ry5 < 3; ++ry5) {
                    for (int32_t rx5 = 0; rx5 < 3; ++rx5) {
                      layer1_2_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx5)) <= ((int64_t)(xx_reuse5 + -2))) && (((int64_t)(xx_reuse5 + -2)) < ((int64_t)33 - ((int64_t)rx5)))) && (((int64_t)1 - ((int64_t)ry5)) <= ((int64_t)(yy_reuse5 + -2)))) && (((int64_t)(yy_reuse5 + -2)) < ((int64_t)33 - ((int64_t)ry5)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_2_conv1_WB[((rx5 + (ry5 * 3)) + (rc5 * 9))])) ^ layer1_2_conv1_weight[(((rx5 + (ry5 * 3)) + (rc5 * 9)) + (ff5 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_2_conv1_sum)));
                    }
                  }
                }
                layer1_2_conv1[((((xx_reuse5 + (yy_reuse5 * 32)) + (ff5 * 1024)) + (nn18 * 16384)) + -66)] = layer1_2_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer1_2_conv2_LB[1632];
    bool layer1_2_conv2_WB[144];
      ...
      for (int32_t ff6 = 0; ff6 < 16; ++ff6) {
        for (int32_t yy_reuse6 = 0; yy_reuse6 < 34; ++yy_reuse6) {
          ...
          for (int32_t xx_reuse6 = 0; xx_reuse6 < 34; ++xx_reuse6) {
            for (int32_t layer1_2_conv2_pad_2 = 0; layer1_2_conv2_pad_2 < 16; ++layer1_2_conv2_pad_2) {
              for (int32_t layer1_2_conv2_pad_1 = 0; layer1_2_conv2_pad_1 < 2; ++layer1_2_conv2_pad_1) {
                layer1_2_conv2_LB[((xx_reuse6 + (layer1_2_conv2_pad_1 * 34)) + (layer1_2_conv2_pad_2 * 102))] = layer1_2_conv2_LB[(((xx_reuse6 + (layer1_2_conv2_pad_1 * 34)) + (layer1_2_conv2_pad_2 * 102)) + 34)];
              }
              layer1_2_conv2_LB[((xx_reuse6 + (layer1_2_conv2_pad_2 * 102)) + 68)] = layer1_2_conv2_pad[(((xx_reuse6 + (yy_reuse6 * 34)) + (layer1_2_conv2_pad_2 * 1156)) + (nn22 * 18496))];
            }
            if (2 <= yy_reuse6) {
              for (int32_t layer1_2_conv2_LB_1 = 0; layer1_2_conv2_LB_1 < 3; ++layer1_2_conv2_LB_1) {
                for (int32_t layer1_2_conv2_LB_2 = 0; layer1_2_conv2_LB_2 < 16; ++layer1_2_conv2_LB_2) {
                  for (int32_t layer1_2_conv2_LB_0 = 0; layer1_2_conv2_LB_0 < 2; ++layer1_2_conv2_LB_0) {
                    layer1_2_conv2_WB[((layer1_2_conv2_LB_0 + (layer1_2_conv2_LB_1 * 3)) + (layer1_2_conv2_LB_2 * 9))] = layer1_2_conv2_WB[(((layer1_2_conv2_LB_0 + (layer1_2_conv2_LB_1 * 3)) + (layer1_2_conv2_LB_2 * 9)) + 1)];
                  }
                  layer1_2_conv2_WB[(((layer1_2_conv2_LB_1 + (layer1_2_conv2_LB_2 * 3)) * 3) + 2)] = layer1_2_conv2_LB[((xx_reuse6 + (layer1_2_conv2_LB_1 * 34)) + (layer1_2_conv2_LB_2 * 102))];
                }
              }
              if (2 <= xx_reuse6) {
                ...
                for (int32_t rc6 = 0; rc6 < 16; ++rc6) {
                  for (int32_t ry6 = 0; ry6 < 3; ++ry6) {
                    for (int32_t rx6 = 0; rx6 < 3; ++rx6) {
                      layer1_2_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx6)) <= ((int64_t)(xx_reuse6 + -2))) && (((int64_t)(xx_reuse6 + -2)) < ((int64_t)33 - ((int64_t)rx6)))) && (((int64_t)1 - ((int64_t)ry6)) <= ((int64_t)(yy_reuse6 + -2)))) && (((int64_t)(yy_reuse6 + -2)) < ((int64_t)33 - ((int64_t)ry6)))) ? ((uint32_t)((((1U - ((uint32_t)layer1_2_conv2_WB[((rx6 + (ry6 * 3)) + (rc6 * 9))])) ^ layer1_2_conv2_weight[(((rx6 + (ry6 * 3)) + (rc6 * 9)) + (ff6 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer1_2_conv2_sum)));
                    }
                  }
                }
                layer1_2_conv2[((((xx_reuse6 + (yy_reuse6 * 32)) + (ff6 * 1024)) + (nn22 * 16384)) + -66)] = layer1_2_conv2_sum;
              }
            }
          }
        }
            ...
            for (int32_t rc7 = 0; rc7 < 16; ++rc7) {
              for (int32_t ry7 = 0; ry7 < 3; ++ry7) {
                for (int32_t rx7 = 0; rx7 < 3; ++rx7) {
                  layer2_0_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx7)) <= ((int64_t)(xx * 2))) && (((int64_t)(xx * 2)) < ((int64_t)33 - ((int64_t)rx7)))) && (((int64_t)1 - ((int64_t)ry7)) <= ((int64_t)(yy * 2)))) && (((int64_t)(yy * 2)) < ((int64_t)33 - ((int64_t)ry7)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_0_conv1_pad[(((((xx * 2) + rx7) + (((yy * 2) + ry7) * 34)) + (rc7 * 1156)) + (nn26 * 18496))])) ^ layer2_0_conv1_weight[(((rx7 + (ry7 * 3)) + (rc7 * 9)) + (ff7 * 144))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_0_conv1_sum)));
                }
              }
            }
            layer2_0_conv1[(((xx + (yy * 16)) + (ff7 * 256)) + (nn26 * 8192))] = layer2_0_conv1_sum;
          }
        }
      }
    }
    ...
    for (int32_t nn31 = 0; nn31 < 1; ++nn31) {
      for (int32_t ff8 = 0; ff8 < 32; ++ff8) {
        for (int32_t yy1 = 0; yy1 < 16; ++yy1) {
          for (int32_t xx1 = 0; xx1 < 16; ++xx1) {
            int8_t layer2_0_conv2_sum;
            for (int32_t rc8 = 0; rc8 < 32; ++rc8) {
              for (int32_t ry8 = 0; ry8 < 3; ++ry8) {
                for (int32_t rx8 = 0; rx8 < 3; ++rx8) {
                  layer2_0_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx8)) <= ((int64_t)xx1)) && (((int64_t)xx1) < ((int64_t)17 - ((int64_t)rx8)))) && (((int64_t)1 - ((int64_t)ry8)) <= ((int64_t)yy1))) && (((int64_t)yy1) < ((int64_t)17 - ((int64_t)ry8)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_0_conv2_pad[((((xx1 + rx8) + ((yy1 + ry8) * 18)) + (rc8 * 324)) + (nn31 * 10368))])) ^ layer2_0_conv2_weight[(((rx8 + (ry8 * 3)) + (rc8 * 9)) + (ff8 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_0_conv2_sum)));
                }
              }
            }
            layer2_0_conv2[(((xx1 + (yy1 * 16)) + (ff8 * 256)) + (nn31 * 8192))] = layer2_0_conv2_sum;
          }
        }
      }
    }
    ...
    bool layer2_1_conv1_LB[1728];
    bool layer2_1_conv1_WB[288];
      ...
      for (int32_t ff9 = 0; ff9 < 32; ++ff9) {
        for (int32_t yy_reuse7 = 0; yy_reuse7 < 18; ++yy_reuse7) {
          ...
          for (int32_t xx_reuse7 = 0; xx_reuse7 < 18; ++xx_reuse7) {
            for (int32_t layer2_1_conv1_pad_2 = 0; layer2_1_conv1_pad_2 < 32; ++layer2_1_conv1_pad_2) {
              for (int32_t layer2_1_conv1_pad_1 = 0; layer2_1_conv1_pad_1 < 2; ++layer2_1_conv1_pad_1) {
                layer2_1_conv1_LB[((xx_reuse7 + (layer2_1_conv1_pad_1 * 18)) + (layer2_1_conv1_pad_2 * 54))] = layer2_1_conv1_LB[(((xx_reuse7 + (layer2_1_conv1_pad_1 * 18)) + (layer2_1_conv1_pad_2 * 54)) + 18)];
              }
              layer2_1_conv1_LB[((xx_reuse7 + (layer2_1_conv1_pad_2 * 54)) + 36)] = layer2_1_conv1_pad[(((xx_reuse7 + (yy_reuse7 * 18)) + (layer2_1_conv1_pad_2 * 324)) + (nn35 * 10368))];
            }
            if (2 <= yy_reuse7) {
              for (int32_t layer2_1_conv1_LB_1 = 0; layer2_1_conv1_LB_1 < 3; ++layer2_1_conv1_LB_1) {
                for (int32_t layer2_1_conv1_LB_2 = 0; layer2_1_conv1_LB_2 < 32; ++layer2_1_conv1_LB_2) {
                  for (int32_t layer2_1_conv1_LB_0 = 0; layer2_1_conv1_LB_0 < 2; ++layer2_1_conv1_LB_0) {
                    layer2_1_conv1_WB[((layer2_1_conv1_LB_0 + (layer2_1_conv1_LB_1 * 3)) + (layer2_1_conv1_LB_2 * 9))] = layer2_1_conv1_WB[(((layer2_1_conv1_LB_0 + (layer2_1_conv1_LB_1 * 3)) + (layer2_1_conv1_LB_2 * 9)) + 1)];
                  }
                  layer2_1_conv1_WB[(((layer2_1_conv1_LB_1 + (layer2_1_conv1_LB_2 * 3)) * 3) + 2)] = layer2_1_conv1_LB[((xx_reuse7 + (layer2_1_conv1_LB_1 * 18)) + (layer2_1_conv1_LB_2 * 54))];
                }
              }
              if (2 <= xx_reuse7) {
                ...
                for (int32_t rc9 = 0; rc9 < 32; ++rc9) {
                  for (int32_t ry9 = 0; ry9 < 3; ++ry9) {
                    for (int32_t rx9 = 0; rx9 < 3; ++rx9) {
                      layer2_1_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx9)) <= ((int64_t)(xx_reuse7 + -2))) && (((int64_t)(xx_reuse7 + -2)) < ((int64_t)17 - ((int64_t)rx9)))) && (((int64_t)1 - ((int64_t)ry9)) <= ((int64_t)(yy_reuse7 + -2)))) && (((int64_t)(yy_reuse7 + -2)) < ((int64_t)17 - ((int64_t)ry9)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_1_conv1_WB[((rx9 + (ry9 * 3)) + (rc9 * 9))])) ^ layer2_1_conv1_weight[(((rx9 + (ry9 * 3)) + (rc9 * 9)) + (ff9 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_1_conv1_sum)));
                    }
                  }
                }
                layer2_1_conv1[((((xx_reuse7 + (yy_reuse7 * 16)) + (ff9 * 256)) + (nn35 * 8192)) + -34)] = layer2_1_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer2_1_conv2_LB[1728];
    bool layer2_1_conv2_WB[288];
      ...
      for (int32_t ff10 = 0; ff10 < 32; ++ff10) {
        for (int32_t yy_reuse8 = 0; yy_reuse8 < 18; ++yy_reuse8) {
          ...
          for (int32_t xx_reuse8 = 0; xx_reuse8 < 18; ++xx_reuse8) {
            for (int32_t layer2_1_conv2_pad_2 = 0; layer2_1_conv2_pad_2 < 32; ++layer2_1_conv2_pad_2) {
              for (int32_t layer2_1_conv2_pad_1 = 0; layer2_1_conv2_pad_1 < 2; ++layer2_1_conv2_pad_1) {
                layer2_1_conv2_LB[((xx_reuse8 + (layer2_1_conv2_pad_1 * 18)) + (layer2_1_conv2_pad_2 * 54))] = layer2_1_conv2_LB[(((xx_reuse8 + (layer2_1_conv2_pad_1 * 18)) + (layer2_1_conv2_pad_2 * 54)) + 18)];
              }
              layer2_1_conv2_LB[((xx_reuse8 + (layer2_1_conv2_pad_2 * 54)) + 36)] = layer2_1_conv2_pad[(((xx_reuse8 + (yy_reuse8 * 18)) + (layer2_1_conv2_pad_2 * 324)) + (nn39 * 10368))];
            }
            if (2 <= yy_reuse8) {
              for (int32_t layer2_1_conv2_LB_1 = 0; layer2_1_conv2_LB_1 < 3; ++layer2_1_conv2_LB_1) {
                for (int32_t layer2_1_conv2_LB_2 = 0; layer2_1_conv2_LB_2 < 32; ++layer2_1_conv2_LB_2) {
                  for (int32_t layer2_1_conv2_LB_0 = 0; layer2_1_conv2_LB_0 < 2; ++layer2_1_conv2_LB_0) {
                    layer2_1_conv2_WB[((layer2_1_conv2_LB_0 + (layer2_1_conv2_LB_1 * 3)) + (layer2_1_conv2_LB_2 * 9))] = layer2_1_conv2_WB[(((layer2_1_conv2_LB_0 + (layer2_1_conv2_LB_1 * 3)) + (layer2_1_conv2_LB_2 * 9)) + 1)];
                  }
                  layer2_1_conv2_WB[(((layer2_1_conv2_LB_1 + (layer2_1_conv2_LB_2 * 3)) * 3) + 2)] = layer2_1_conv2_LB[((xx_reuse8 + (layer2_1_conv2_LB_1 * 18)) + (layer2_1_conv2_LB_2 * 54))];
                }
              }
              if (2 <= xx_reuse8) {
                ...
                for (int32_t rc10 = 0; rc10 < 32; ++rc10) {
                  for (int32_t ry10 = 0; ry10 < 3; ++ry10) {
                    for (int32_t rx10 = 0; rx10 < 3; ++rx10) {
                      layer2_1_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx10)) <= ((int64_t)(xx_reuse8 + -2))) && (((int64_t)(xx_reuse8 + -2)) < ((int64_t)17 - ((int64_t)rx10)))) && (((int64_t)1 - ((int64_t)ry10)) <= ((int64_t)(yy_reuse8 + -2)))) && (((int64_t)(yy_reuse8 + -2)) < ((int64_t)17 - ((int64_t)ry10)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_1_conv2_WB[((rx10 + (ry10 * 3)) + (rc10 * 9))])) ^ layer2_1_conv2_weight[(((rx10 + (ry10 * 3)) + (rc10 * 9)) + (ff10 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_1_conv2_sum)));
                    }
                  }
                }
                layer2_1_conv2[((((xx_reuse8 + (yy_reuse8 * 16)) + (ff10 * 256)) + (nn39 * 8192)) + -34)] = layer2_1_conv2_sum;
              }
            }
          }
        }
    ...
    bool layer2_2_conv1_LB[1728];
    bool layer2_2_conv1_WB[288];
      ...
      for (int32_t ff11 = 0; ff11 < 32; ++ff11) {
        for (int32_t yy_reuse9 = 0; yy_reuse9 < 18; ++yy_reuse9) {
          ...
          for (int32_t xx_reuse9 = 0; xx_reuse9 < 18; ++xx_reuse9) {
            for (int32_t layer2_2_conv1_pad_2 = 0; layer2_2_conv1_pad_2 < 32; ++layer2_2_conv1_pad_2) {
              for (int32_t layer2_2_conv1_pad_1 = 0; layer2_2_conv1_pad_1 < 2; ++layer2_2_conv1_pad_1) {
                layer2_2_conv1_LB[((xx_reuse9 + (layer2_2_conv1_pad_1 * 18)) + (layer2_2_conv1_pad_2 * 54))] = layer2_2_conv1_LB[(((xx_reuse9 + (layer2_2_conv1_pad_1 * 18)) + (layer2_2_conv1_pad_2 * 54)) + 18)];
              }
              layer2_2_conv1_LB[((xx_reuse9 + (layer2_2_conv1_pad_2 * 54)) + 36)] = layer2_2_conv1_pad[(((xx_reuse9 + (yy_reuse9 * 18)) + (layer2_2_conv1_pad_2 * 324)) + (nn43 * 10368))];
            }
            if (2 <= yy_reuse9) {
              for (int32_t layer2_2_conv1_LB_1 = 0; layer2_2_conv1_LB_1 < 3; ++layer2_2_conv1_LB_1) {
                for (int32_t layer2_2_conv1_LB_2 = 0; layer2_2_conv1_LB_2 < 32; ++layer2_2_conv1_LB_2) {
                  for (int32_t layer2_2_conv1_LB_0 = 0; layer2_2_conv1_LB_0 < 2; ++layer2_2_conv1_LB_0) {
                    layer2_2_conv1_WB[((layer2_2_conv1_LB_0 + (layer2_2_conv1_LB_1 * 3)) + (layer2_2_conv1_LB_2 * 9))] = layer2_2_conv1_WB[(((layer2_2_conv1_LB_0 + (layer2_2_conv1_LB_1 * 3)) + (layer2_2_conv1_LB_2 * 9)) + 1)];
                  }
                  layer2_2_conv1_WB[(((layer2_2_conv1_LB_1 + (layer2_2_conv1_LB_2 * 3)) * 3) + 2)] = layer2_2_conv1_LB[((xx_reuse9 + (layer2_2_conv1_LB_1 * 18)) + (layer2_2_conv1_LB_2 * 54))];
                }
              }
              if (2 <= xx_reuse9) {
                ...
                for (int32_t rc11 = 0; rc11 < 32; ++rc11) {
                  for (int32_t ry11 = 0; ry11 < 3; ++ry11) {
                    for (int32_t rx11 = 0; rx11 < 3; ++rx11) {
                      layer2_2_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx11)) <= ((int64_t)(xx_reuse9 + -2))) && (((int64_t)(xx_reuse9 + -2)) < ((int64_t)17 - ((int64_t)rx11)))) && (((int64_t)1 - ((int64_t)ry11)) <= ((int64_t)(yy_reuse9 + -2)))) && (((int64_t)(yy_reuse9 + -2)) < ((int64_t)17 - ((int64_t)ry11)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_2_conv1_WB[((rx11 + (ry11 * 3)) + (rc11 * 9))])) ^ layer2_2_conv1_weight[(((rx11 + (ry11 * 3)) + (rc11 * 9)) + (ff11 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_2_conv1_sum)));
                    }
                  }
                }
                layer2_2_conv1[((((xx_reuse9 + (yy_reuse9 * 16)) + (ff11 * 256)) + (nn43 * 8192)) + -34)] = layer2_2_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer2_2_conv2_LB[1728];
    bool layer2_2_conv2_WB[288];
      ...
      for (int32_t ff12 = 0; ff12 < 32; ++ff12) {
        for (int32_t yy_reuse10 = 0; yy_reuse10 < 18; ++yy_reuse10) {
          ...
          for (int32_t xx_reuse10 = 0; xx_reuse10 < 18; ++xx_reuse10) {
            for (int32_t layer2_2_conv2_pad_2 = 0; layer2_2_conv2_pad_2 < 32; ++layer2_2_conv2_pad_2) {
              for (int32_t layer2_2_conv2_pad_1 = 0; layer2_2_conv2_pad_1 < 2; ++layer2_2_conv2_pad_1) {
                layer2_2_conv2_LB[((xx_reuse10 + (layer2_2_conv2_pad_1 * 18)) + (layer2_2_conv2_pad_2 * 54))] = layer2_2_conv2_LB[(((xx_reuse10 + (layer2_2_conv2_pad_1 * 18)) + (layer2_2_conv2_pad_2 * 54)) + 18)];
              }
              layer2_2_conv2_LB[((xx_reuse10 + (layer2_2_conv2_pad_2 * 54)) + 36)] = layer2_2_conv2_pad[(((xx_reuse10 + (yy_reuse10 * 18)) + (layer2_2_conv2_pad_2 * 324)) + (nn47 * 10368))];
            }
            if (2 <= yy_reuse10) {
              for (int32_t layer2_2_conv2_LB_1 = 0; layer2_2_conv2_LB_1 < 3; ++layer2_2_conv2_LB_1) {
                for (int32_t layer2_2_conv2_LB_2 = 0; layer2_2_conv2_LB_2 < 32; ++layer2_2_conv2_LB_2) {
                  for (int32_t layer2_2_conv2_LB_0 = 0; layer2_2_conv2_LB_0 < 2; ++layer2_2_conv2_LB_0) {
                    layer2_2_conv2_WB[((layer2_2_conv2_LB_0 + (layer2_2_conv2_LB_1 * 3)) + (layer2_2_conv2_LB_2 * 9))] = layer2_2_conv2_WB[(((layer2_2_conv2_LB_0 + (layer2_2_conv2_LB_1 * 3)) + (layer2_2_conv2_LB_2 * 9)) + 1)];
                  }
                  layer2_2_conv2_WB[(((layer2_2_conv2_LB_1 + (layer2_2_conv2_LB_2 * 3)) * 3) + 2)] = layer2_2_conv2_LB[((xx_reuse10 + (layer2_2_conv2_LB_1 * 18)) + (layer2_2_conv2_LB_2 * 54))];
                }
              }
              if (2 <= xx_reuse10) {
                ...
                for (int32_t rc12 = 0; rc12 < 32; ++rc12) {
                  for (int32_t ry12 = 0; ry12 < 3; ++ry12) {
                    for (int32_t rx12 = 0; rx12 < 3; ++rx12) {
                      layer2_2_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx12)) <= ((int64_t)(xx_reuse10 + -2))) && (((int64_t)(xx_reuse10 + -2)) < ((int64_t)17 - ((int64_t)rx12)))) && (((int64_t)1 - ((int64_t)ry12)) <= ((int64_t)(yy_reuse10 + -2)))) && (((int64_t)(yy_reuse10 + -2)) < ((int64_t)17 - ((int64_t)ry12)))) ? ((uint32_t)((((1U - ((uint32_t)layer2_2_conv2_WB[((rx12 + (ry12 * 3)) + (rc12 * 9))])) ^ layer2_2_conv2_weight[(((rx12 + (ry12 * 3)) + (rc12 * 9)) + (ff12 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer2_2_conv2_sum)));
                    }
                  }
                }
                layer2_2_conv2[((((xx_reuse10 + (yy_reuse10 * 16)) + (ff12 * 256)) + (nn47 * 8192)) + -34)] = layer2_2_conv2_sum;
              }
            }
          }
        }
    ...
    for (int32_t nn51 = 0; nn51 < 1; ++nn51) {
      for (int32_t ff13 = 0; ff13 < 64; ++ff13) {
        for (int32_t yy2 = 0; yy2 < 8; ++yy2) {
          for (int32_t xx2 = 0; xx2 < 8; ++xx2) {
            int8_t layer3_0_conv1_sum;
            for (int32_t rc13 = 0; rc13 < 32; ++rc13) {
              for (int32_t ry13 = 0; ry13 < 3; ++ry13) {
                for (int32_t rx13 = 0; rx13 < 3; ++rx13) {
                  layer3_0_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx13)) <= ((int64_t)(xx2 * 2))) && (((int64_t)(xx2 * 2)) < ((int64_t)17 - ((int64_t)rx13)))) && (((int64_t)1 - ((int64_t)ry13)) <= ((int64_t)(yy2 * 2)))) && (((int64_t)(yy2 * 2)) < ((int64_t)17 - ((int64_t)ry13)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_0_conv1_pad[(((((xx2 * 2) + rx13) + (((yy2 * 2) + ry13) * 18)) + (rc13 * 324)) + (nn51 * 10368))])) ^ layer3_0_conv1_weight[(((rx13 + (ry13 * 3)) + (rc13 * 9)) + (ff13 * 288))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_0_conv1_sum)));
                }
              }
            }
            layer3_0_conv1[(((xx2 + (yy2 * 8)) + (ff13 * 64)) + (nn51 * 4096))] = layer3_0_conv1_sum;
          }
        }
      }
    }
    ...
    for (int32_t nn56 = 0; nn56 < 1; ++nn56) {
      for (int32_t ff14 = 0; ff14 < 64; ++ff14) {
        for (int32_t yy3 = 0; yy3 < 8; ++yy3) {
          for (int32_t xx3 = 0; xx3 < 8; ++xx3) {
            int8_t layer3_0_conv2_sum;
            for (int32_t rc14 = 0; rc14 < 64; ++rc14) {
              for (int32_t ry14 = 0; ry14 < 3; ++ry14) {
                for (int32_t rx14 = 0; rx14 < 3; ++rx14) {
                  layer3_0_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx14)) <= ((int64_t)xx3)) && (((int64_t)xx3) < ((int64_t)9 - ((int64_t)rx14)))) && (((int64_t)1 - ((int64_t)ry14)) <= ((int64_t)yy3))) && (((int64_t)yy3) < ((int64_t)9 - ((int64_t)ry14)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_0_conv2_pad[((((xx3 + rx14) + ((yy3 + ry14) * 10)) + (rc14 * 100)) + (nn56 * 6400))])) ^ layer3_0_conv2_weight[(((rx14 + (ry14 * 3)) + (rc14 * 9)) + (ff14 * 576))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_0_conv2_sum)));
                }
              }
            }
            layer3_0_conv2[(((xx3 + (yy3 * 8)) + (ff14 * 64)) + (nn56 * 4096))] = layer3_0_conv2_sum;
          }
        }
      }
    }
    ...
    bool layer3_1_conv1_LB[1920];
    bool layer3_1_conv1_WB[576];
    for (int32_t nn60 = 0; nn60 < 1; ++nn60) {
      for (int32_t ff15 = 0; ff15 < 64; ++ff15) {
        for (int32_t yy_reuse11 = 0; yy_reuse11 < 10; ++yy_reuse11) {
          #pragma ii 1
          for (int32_t xx_reuse11 = 0; xx_reuse11 < 10; ++xx_reuse11) {
            for (int32_t layer3_1_conv1_pad_2 = 0; layer3_1_conv1_pad_2 < 64; ++layer3_1_conv1_pad_2) {
              for (int32_t layer3_1_conv1_pad_1 = 0; layer3_1_conv1_pad_1 < 2; ++layer3_1_conv1_pad_1) {
                layer3_1_conv1_LB[((xx_reuse11 + (layer3_1_conv1_pad_1 * 10)) + (layer3_1_conv1_pad_2 * 30))] = layer3_1_conv1_LB[(((xx_reuse11 + (layer3_1_conv1_pad_1 * 10)) + (layer3_1_conv1_pad_2 * 30)) + 10)];
              }
              layer3_1_conv1_LB[((xx_reuse11 + (layer3_1_conv1_pad_2 * 30)) + 20)] = layer3_1_conv1_pad[(((xx_reuse11 + (yy_reuse11 * 10)) + (layer3_1_conv1_pad_2 * 100)) + (nn60 * 6400))];
            }
            if (2 <= yy_reuse11) {
              for (int32_t layer3_1_conv1_LB_1 = 0; layer3_1_conv1_LB_1 < 3; ++layer3_1_conv1_LB_1) {
                for (int32_t layer3_1_conv1_LB_2 = 0; layer3_1_conv1_LB_2 < 64; ++layer3_1_conv1_LB_2) {
                  ...
                  layer3_1_conv1_WB[(((layer3_1_conv1_LB_1 + (layer3_1_conv1_LB_2 * 3)) * 3) + 2)] = layer3_1_conv1_LB[((xx_reuse11 + (layer3_1_conv1_LB_1 * 10)) + (layer3_1_conv1_LB_2 * 30))];
                }
              }
              if (2 <= xx_reuse11) {
                ...
                for (int32_t rc15 = 0; rc15 < 64; ++rc15) {
                  for (int32_t ry15 = 0; ry15 < 3; ++ry15) {
                    for (int32_t rx15 = 0; rx15 < 3; ++rx15) {
                      layer3_1_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx15)) <= ((int64_t)(xx_reuse11 + -2))) && (((int64_t)(xx_reuse11 + -2)) < ((int64_t)9 - ((int64_t)rx15)))) && (((int64_t)1 - ((int64_t)ry15)) <= ((int64_t)(yy_reuse11 + -2)))) && (((int64_t)(yy_reuse11 + -2)) < ((int64_t)9 - ((int64_t)ry15)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_1_conv1_WB[((rx15 + (ry15 * 3)) + (rc15 * 9))])) ^ layer3_1_conv1_weight[(((rx15 + (ry15 * 3)) + (rc15 * 9)) + (ff15 * 576))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_1_conv1_sum)));
                    }
                  }
                }
                layer3_1_conv1[((((xx_reuse11 + (yy_reuse11 * 8)) + (ff15 * 64)) + (nn60 * 4096)) + -18)] = layer3_1_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer3_1_conv2_LB[1920];
    bool layer3_1_conv2_WB[576];
      ...
      for (int32_t ff16 = 0; ff16 < 64; ++ff16) {
        for (int32_t yy_reuse12 = 0; yy_reuse12 < 10; ++yy_reuse12) {
          ...
          for (int32_t xx_reuse12 = 0; xx_reuse12 < 10; ++xx_reuse12) {
            for (int32_t layer3_1_conv2_pad_2 = 0; layer3_1_conv2_pad_2 < 64; ++layer3_1_conv2_pad_2) {
              for (int32_t layer3_1_conv2_pad_1 = 0; layer3_1_conv2_pad_1 < 2; ++layer3_1_conv2_pad_1) {
                layer3_1_conv2_LB[((xx_reuse12 + (layer3_1_conv2_pad_1 * 10)) + (layer3_1_conv2_pad_2 * 30))] = layer3_1_conv2_LB[(((xx_reuse12 + (layer3_1_conv2_pad_1 * 10)) + (layer3_1_conv2_pad_2 * 30)) + 10)];
              }
              layer3_1_conv2_LB[((xx_reuse12 + (layer3_1_conv2_pad_2 * 30)) + 20)] = layer3_1_conv2_pad[(((xx_reuse12 + (yy_reuse12 * 10)) + (layer3_1_conv2_pad_2 * 100)) + (nn64 * 6400))];
            }
            if (2 <= yy_reuse12) {
              for (int32_t layer3_1_conv2_LB_1 = 0; layer3_1_conv2_LB_1 < 3; ++layer3_1_conv2_LB_1) {
                for (int32_t layer3_1_conv2_LB_2 = 0; layer3_1_conv2_LB_2 < 64; ++layer3_1_conv2_LB_2) {
                  ...
                  layer3_1_conv2_WB[(((layer3_1_conv2_LB_1 + (layer3_1_conv2_LB_2 * 3)) * 3) + 2)] = layer3_1_conv2_LB[((xx_reuse12 + (layer3_1_conv2_LB_1 * 10)) + (layer3_1_conv2_LB_2 * 30))];
                }
              }
              if (2 <= xx_reuse12) {
                ...
                for (int32_t rc16 = 0; rc16 < 64; ++rc16) {
                  for (int32_t ry16 = 0; ry16 < 3; ++ry16) {
                    for (int32_t rx16 = 0; rx16 < 3; ++rx16) {
                      layer3_1_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx16)) <= ((int64_t)(xx_reuse12 + -2))) && (((int64_t)(xx_reuse12 + -2)) < ((int64_t)9 - ((int64_t)rx16)))) && (((int64_t)1 - ((int64_t)ry16)) <= ((int64_t)(yy_reuse12 + -2)))) && (((int64_t)(yy_reuse12 + -2)) < ((int64_t)9 - ((int64_t)ry16)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_1_conv2_WB[((rx16 + (ry16 * 3)) + (rc16 * 9))])) ^ layer3_1_conv2_weight[(((rx16 + (ry16 * 3)) + (rc16 * 9)) + (ff16 * 576))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_1_conv2_sum)));
                    }
                  }
                }
                layer3_1_conv2[((((xx_reuse12 + (yy_reuse12 * 8)) + (ff16 * 64)) + (nn64 * 4096)) + -18)] = layer3_1_conv2_sum;
              }
            }
          }
        }
    ...
    bool layer3_2_conv1_LB[1920];
    bool layer3_2_conv1_WB[576];
      ...
      for (int32_t ff17 = 0; ff17 < 64; ++ff17) {
        for (int32_t yy_reuse13 = 0; yy_reuse13 < 10; ++yy_reuse13) {
          ...
          for (int32_t xx_reuse13 = 0; xx_reuse13 < 10; ++xx_reuse13) {
            for (int32_t layer3_2_conv1_pad_2 = 0; layer3_2_conv1_pad_2 < 64; ++layer3_2_conv1_pad_2) {
              for (int32_t layer3_2_conv1_pad_1 = 0; layer3_2_conv1_pad_1 < 2; ++layer3_2_conv1_pad_1) {
                layer3_2_conv1_LB[((xx_reuse13 + (layer3_2_conv1_pad_1 * 10)) + (layer3_2_conv1_pad_2 * 30))] = layer3_2_conv1_LB[(((xx_reuse13 + (layer3_2_conv1_pad_1 * 10)) + (layer3_2_conv1_pad_2 * 30)) + 10)];
              }
              layer3_2_conv1_LB[((xx_reuse13 + (layer3_2_conv1_pad_2 * 30)) + 20)] = layer3_2_conv1_pad[(((xx_reuse13 + (yy_reuse13 * 10)) + (layer3_2_conv1_pad_2 * 100)) + (nn68 * 6400))];
            }
            if (2 <= yy_reuse13) {
              for (int32_t layer3_2_conv1_LB_1 = 0; layer3_2_conv1_LB_1 < 3; ++layer3_2_conv1_LB_1) {
                for (int32_t layer3_2_conv1_LB_2 = 0; layer3_2_conv1_LB_2 < 64; ++layer3_2_conv1_LB_2) {
                  ...
                  layer3_2_conv1_WB[(((layer3_2_conv1_LB_1 + (layer3_2_conv1_LB_2 * 3)) * 3) + 2)] = layer3_2_conv1_LB[((xx_reuse13 + (layer3_2_conv1_LB_1 * 10)) + (layer3_2_conv1_LB_2 * 30))];
                }
              }
              if (2 <= xx_reuse13) {
                ...
                for (int32_t rc17 = 0; rc17 < 64; ++rc17) {
                  for (int32_t ry17 = 0; ry17 < 3; ++ry17) {
                    for (int32_t rx17 = 0; rx17 < 3; ++rx17) {
                      layer3_2_conv1_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx17)) <= ((int64_t)(xx_reuse13 + -2))) && (((int64_t)(xx_reuse13 + -2)) < ((int64_t)9 - ((int64_t)rx17)))) && (((int64_t)1 - ((int64_t)ry17)) <= ((int64_t)(yy_reuse13 + -2)))) && (((int64_t)(yy_reuse13 + -2)) < ((int64_t)9 - ((int64_t)ry17)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_2_conv1_WB[((rx17 + (ry17 * 3)) + (rc17 * 9))])) ^ layer3_2_conv1_weight[(((rx17 + (ry17 * 3)) + (rc17 * 9)) + (ff17 * 576))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_2_conv1_sum)));
                    }
                  }
                }
                layer3_2_conv1[((((xx_reuse13 + (yy_reuse13 * 8)) + (ff17 * 64)) + (nn68 * 4096)) + -18)] = layer3_2_conv1_sum;
              }
            }
          }
        }
    ...
    bool layer3_2_conv2_LB[1920];
    bool layer3_2_conv2_WB[576];
      ...
      for (int32_t ff18 = 0; ff18 < 64; ++ff18) {
        for (int32_t yy_reuse14 = 0; yy_reuse14 < 10; ++yy_reuse14) {
          ...
          for (int32_t xx_reuse14 = 0; xx_reuse14 < 10; ++xx_reuse14) {
            for (int32_t layer3_2_conv2_pad_2 = 0; layer3_2_conv2_pad_2 < 64; ++layer3_2_conv2_pad_2) {
              for (int32_t layer3_2_conv2_pad_1 = 0; layer3_2_conv2_pad_1 < 2; ++layer3_2_conv2_pad_1) {
                layer3_2_conv2_LB[((xx_reuse14 + (layer3_2_conv2_pad_1 * 10)) + (layer3_2_conv2_pad_2 * 30))] = layer3_2_conv2_LB[(((xx_reuse14 + (layer3_2_conv2_pad_1 * 10)) + (layer3_2_conv2_pad_2 * 30)) + 10)];
              }
              layer3_2_conv2_LB[((xx_reuse14 + (layer3_2_conv2_pad_2 * 30)) + 20)] = layer3_2_conv2_pad[(((xx_reuse14 + (yy_reuse14 * 10)) + (layer3_2_conv2_pad_2 * 100)) + (nn72 * 6400))];
            }
            if (2 <= yy_reuse14) {
              for (int32_t layer3_2_conv2_LB_1 = 0; layer3_2_conv2_LB_1 < 3; ++layer3_2_conv2_LB_1) {
                for (int32_t layer3_2_conv2_LB_2 = 0; layer3_2_conv2_LB_2 < 64; ++layer3_2_conv2_LB_2) {
                  ...
                  layer3_2_conv2_WB[(((layer3_2_conv2_LB_1 + (layer3_2_conv2_LB_2 * 3)) * 3) + 2)] = layer3_2_conv2_LB[((xx_reuse14 + (layer3_2_conv2_LB_1 * 10)) + (layer3_2_conv2_LB_2 * 30))];
                }
              }
              if (2 <= xx_reuse14) {
                ...
                for (int32_t rc18 = 0; rc18 < 64; ++rc18) {
                  for (int32_t ry18 = 0; ry18 < 3; ++ry18) {
                    for (int32_t rx18 = 0; rx18 < 3; ++rx18) {
                      layer3_2_conv2_sum = ((int8_t)(((int64_t)(uint32_t)(((((((int64_t)1 - ((int64_t)rx18)) <= ((int64_t)(xx_reuse14 + -2))) && (((int64_t)(xx_reuse14 + -2)) < ((int64_t)9 - ((int64_t)rx18)))) && (((int64_t)1 - ((int64_t)ry18)) <= ((int64_t)(yy_reuse14 + -2)))) && (((int64_t)(yy_reuse14 + -2)) < ((int64_t)9 - ((int64_t)ry18)))) ? ((uint32_t)((((1U - ((uint32_t)layer3_2_conv2_WB[((rx18 + (ry18 * 3)) + (rc18 * 9))])) ^ layer3_2_conv2_weight[(((rx18 + (ry18 * 3)) + (rc18 * 9)) + (ff18 * 576))]) << 1) - 1U)) : ((uint32_t)0U))) + ((int64_t)layer3_2_conv2_sum)));
                    }
                  }
                }
                layer3_2_conv2[((((xx_reuse14 + (yy_reuse14 * 8)) + (ff18 * 64)) + (nn72 * 4096)) + -18)] = layer3_2_conv2_sum;
              }
            }
          }
        }
